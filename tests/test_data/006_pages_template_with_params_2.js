{
		...
		"pageText": [
			{
				...
				"text": [
					...
					"|шаблоны с параметром = Просто шаблон, rq/notability/ , Музыкальный коллектив/Язык/Русский язык, Музыкальный коллектив/Язык/русский язык",
					"}}"]
			},
			{
				"title": "Тень солнца",
		...
		"firstRevision": [
			{
				...
				"revid": 688, "timestamp": 1436837810000, "title": "Another Case", "summary": "create new page",
	...
	"wiki_tools" : [[
		...
		"6	Another_Case	5882971	17000	20160624101036"]
	],
	"expected_edits": [
		{
	...
	"expected_tools_queries": [
		{
			"contains": ["Метал-группы России", "Метал-группы Белоруссии", "Метал-группы Украины", "Просто шаблон", "Rq", "Музыкальный коллектив"]
		}
	]
}