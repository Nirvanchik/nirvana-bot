...
/**
 * Unit tests for {@link BotTemplateParser}.
 *
 */
public class BotTemplateParserTest {

    @Test
    public void testGetUserTemplateRe_findsWhenTemplateNoNs() {
        Pattern p = Pattern.compile(BotTemplateParser.getUserTemplateRe("MyBot", null));
    ...
    public void testGetUserTemplateRe_findsWhenTemplateWithEnNs() {
        Pattern p = Pattern.compile(BotTemplateParser.getUserTemplateRe("User:MyBot", null));
        String text = "Xyz.  {{User:MyBot|param1=value1}} blablabla";
        Assert.assertTrue(p.matcher(text).find());
    }
    ...
    public void testGetUserTemplateRe_findsLocalizedNsTitleNoNs() {
        Pattern p = Pattern.compile(BotTemplateParser.getUserTemplateRe("MyBot", "Участник"));
    ...
    public void testGetUserTemplateRe_findsLocalizedNsTitleEnNs() {
        Pattern p = Pattern.compile(BotTemplateParser.getUserTemplateRe("User:MyBot", "Участник"));
    ...
    public void testGetUserTemplateRe_findsLocalizedNsTitleLocNs() {
        Pattern p = Pattern.compile(
                BotTemplateParser.getUserTemplateRe("Участник:MyBot", "Участник"));
