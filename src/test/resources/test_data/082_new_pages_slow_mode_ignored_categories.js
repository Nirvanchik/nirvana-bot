{
		...
		"pageText": [
			{
				...
				"text": [
					...
					"|тип = новые статьи",
					"|категории = Собаки, Злые собаки",
					"|страница = Проект:Project 1/Новые статьи",
					"|быстрый режим = нет",
					"|игнорировать = Вымышленные собаки",
					"}}"]
            },
            {
	...
	"wiki_tools" : [[
		...
		"number	title	pageid	namespace	length	touched",
		"1	Серо-буро-малиновый_пенчекряк	686		23643	20160531174602",
		"2	Квазисобака	666		26808	20160603134155"
		]],
	"expected_edits": [
		{
			"title": "Проект:Project 1/Новые статьи",
	...
	"expected_tools_queries": [
		...
		{
			"contains": ["Злые собаки"]
		},
		{
			"contains": ["Вымышленные собаки"]
		}
	]
}