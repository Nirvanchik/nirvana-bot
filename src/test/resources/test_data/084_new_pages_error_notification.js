	...
	"expected_edits": [
		{
			...
			"text": [
                ...
                "* Ошибка в параметре \"сервис\". Задано неправильное значение (jonny).",
                "* Тип \"всякие статьи\" не поддерживается. Используйте только разрешенные значения в параметре \"тип\".",
