		...
		"pageText": [
			{
				...
				"text": [
					...
					"|тип = новые статьи",
					"|категории = Собаки, Злые собаки#3",
					"|страница = Проект:Project 1/Новые статьи",
					"|формат элемента = %(название) - %(собака)",
					"}}"]
            },
            {
	...
	"expected_edits": [
		{
			...
			"text": [
                ...
                "* org.wikipedia.nirvana.error.InvalidLineFormatException: В параметре формат элемента обнаружены нераспознанные ключи: %(собака).",
