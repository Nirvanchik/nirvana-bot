{
	"wiki" : {
		"whatTranscludesHere": [
			{ "title": "Удзельнік:Bot template", "list": "Праект:Project 1/Новыя артыкулы/Параметры" }
		],
		"namespaceIdentifier": [
			{ "number": 0, "id": "" },
			{ "number": 2, "id": "Удзельнік" }
		],
		"pageText": [
			{
				"title": "Праект:Project 1/Новыя артыкулы/Параметры",
				"text": [
					"{{Удзельнік:Bot template",
					"|тып = новыя артыкулы",
					"|катэгорыі = Собаки",
					"|старонка = Праект:Project 1/Новыя артыкулы",
					"}}"]
            },
            {
                "title": "Праект:Project 1/Новыя артыкулы",
                "text": null
            }
		],
		"firstRevision": [
