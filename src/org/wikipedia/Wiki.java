...
public class Wiki implements Serializable
{
    ...
    private boolean highLimitEnabled = true;
    ...
    public void enableHightLimit(boolean enabled) {
    	highLimitEnabled = enabled;
    }
    ...
    public synchronized void login(String username, char[] password, boolean rateLimit) throws IOException, FailedLoginException
    {
        ...
        if (line.contains("result=\"Success\""))
        {
            ...
            if (apihighlimit && highLimitEnabled)
            {
                max = 5000;
                slowmax = 500;
            }
    ...
    public Map[] getPageInfo(String[] pages) throws IOException
    {
        ...
        for (String temp : titles)
        {
            ...
            String line = fetch(urlString + temp, "getPageInfo");
            ...
            for (int j = line.indexOf("<page "); j > 0; j = line.indexOf("<page ", ++j))
            {
                ...
                if (user != null)
                {
                    ...
                    log(Level.WARNING, "getPageInfo", "watchtoken is deprecated and will be removed shortly.");
                }
    ...
    protected synchronized boolean checkLag(URLConnection connection)
    {
        ...
        if (lag > maxlag)
        {
            try
            {
                ...
                log(Level.WARNING, "checkLag", "Current database lag " + lag + " s exceeds " + maxlag + " s, waiting " + time + " s.");
